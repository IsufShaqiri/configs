...
# qutebrowser`.
# Type: Dict
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}', 'aw': 'https://wiki.archlinux.org/?search={}', 'goog': 'https://www.google.com/search?q={}', 're': 'https://www.reddit.com/r/{}', 'yt': 'https://www.youtube.com/results?search_query={}'}
...
# Type: Font
c.fonts.completion.entry = '12pt "Hermit"'

# Font used for the debugging console.
# Type: Font
c.fonts.debug_console = '12pt "Hermit"'
...
config.bind('M', 'hint links spawn mpv --cache 8 {hint-url}')
config.bind('Z', 'hint links spawn st -e youtube-dl {hint-url}')
config.bind('t', 'set-cmd-text -s :open -t')
config.bind('xb', 'config-cycle statusbar.show always never')
config.bind('xt', 'config-cycle tabs.show always never')
config.bind('xx', 'config-cycle statusbar.show always never;; config-cycle tabs.show always never')
config.bind(',yt', 'set-cmd-text :open -t https://www.youtube.com/results?search_query={}')
config.bind(',vl', 'set-cmd-text :open -t https://voidlinux.org/')
config.source('themes/themes/default/base16-tomorrow-night.config.py')
