...
hl.on("hyprland.start", function()
	hl.exec_cmd(
		"hyprpaper & waybar & systemctl --user start hyprpolkitagent & hypridle & ~/.config/waybar/auto-reload.sh"
	)
	hl.exec_cmd("systemctl --user enable --now mpDris2")
...
hl.bind(secondMod .. " + RETURN", hl.dsp.exec_cmd(menu))
