...
local function factory(args)
    ...
    local APPID                 = "e83ea912a18834ae8052e24c03e80b52" -- mandatory api key
    local timeout               = args.timeout or 900 -- 15 min
    local current_call          = args.current_call  or "curl -s 'https://api.openweathermap.org/data/2.5/weather?id=790674&APPID=e83ea912a18834ae8052e24c03e80b52&units=metric'"
    local forecast_call         = args.forecast_call or "curl -s 'https://api.openweathermap.org/data/2.5/forecast?id=790674&lang=sq&APPID=e83ea912a18834ae8052e24c03e80b52&units=metric'"
    local lat                   = args.lat or "42.465338" -- placeholder
    local lon                   = args.lon or "21.471641" -- placeholder
    local units                 = args.units or "metric"
    local lang                  = args.lang or "sq"
