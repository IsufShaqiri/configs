...
theme.font                                      = "Hack Nerd Font 10.5"
...
awful.util.tagnames   = { "dev", "www", "sys", "doc", "vid" }
...
theme.fs = lain.widget.fs({
    notification_preset = { fg = white, bg = theme.bg_normal, font = "Hack Nerd Font 10.5" },
    settings  = function()
        fs_header = ""
        fs_p      = ""
...
-- Separators
local first     = wibox.widget.textbox('<span font="Hack Nerd Font 4"> </span>')
