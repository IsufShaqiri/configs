...
local function factory(args)
    ...
    local current_call          = args.current_call  or "curl -s 'https://api.openweathermap.org/data/2.5/weather?lat=42.45&lon=21.47&appid=e83ea912a18834ae8052e24c03e80b52&units=metric'"
    local forecast_call         = args.forecast_call or "curl -s 'https://api.openweathermap.org/data/2.5/forecast?lat=42.45&lon=21.47&appid=e83ea912a18834ae8052e24c03e80b52&units=metric'"
