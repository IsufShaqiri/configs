...
run_once({ "unclutter -root", "picom", "/usr/bin/setxkbmap -option caps:super", "dunst", "mpd", "xfce4-power-manager", "lxsession" }) -- comma-separated entries
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "v", function() awful.util.spawn("alacritty -e pulsemixer") end,
      {description = "volume mixer", group = "launcher"}),
    ...
    awful.key({ modkey }, "d", function ()
            awful.util.spawn("dmenu_run -l 20 -g 4 -X 0 -Y 0 -W 680 -p 'Run: '")
        end,
